<template>
  <div class="modulo-container">
    <div class="content-header">
      <h1>Mi Perfil</h1>
      <p>Actualice su información personal. Mantenga sus datos al día para la entrega de servicios.</p>
    </div>
    ...
    <div class="profile-card">
      <form @submit.prevent="guardarCambios" class="profile-form">
        ...
        <div class="form-group email-group">
          ...
          <span class="help-text">El correo electrónico no puede modificarse salvo circunstancias debidamente justificadas contactando a soporte.</span>
        </div>
...
onMounted(() => {
  perfil.value = {
    ...
    correo: localStorage.getItem('tf_user') || 'cliente@trackflow.com'
  };
});
