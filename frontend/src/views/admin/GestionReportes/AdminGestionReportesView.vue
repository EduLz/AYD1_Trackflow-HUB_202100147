...
<style scoped>
.ad-content { margin-top: 60px; 
               margin-left: 240px; 
               padding: 2rem; 
               min-height: calc(100vh - 60px); 
               background-color: var(--bg-primary); }
.ad-header { display: flex; 
             justify-content: space-between; 
             align-items: center; 
             margin-bottom: 2rem; }
.ad-header h1 { font-size: 1.8rem; 
               color: var(--text-main); 
               margin-bottom: 0.2rem; }
.ad-subtitle { color: var(--text-muted); 
                font-size: 0.95rem; }
.btn-refresh { padding: 0.5rem 1rem; 
